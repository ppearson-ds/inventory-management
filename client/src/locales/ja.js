export default {
  ...
  restocking: {
    title: '再入荷',
    description: '予算を割り当ててスマートな再入荷推薦を取得',
    budget: '再入荷予算',
    itemsToRestock: '再入荷品目数',
    budgetUsed: '使用済み予算',
    budgetRemaining: '残余予算',
    recommendations: '推薦品目',
    excludedItems: '除外品目',
    excludedNote: '予算不足または需要減少のため除外された品目',
    placeOrder: '再入荷注文を発注',
    orderPlaced: '再入荷注文が正常に発注されました',
    noRecommendations: '現在の予算内に再入荷する品目がありません',
    table: {
      sku: 'SKU',
      itemName: '品目名',
      currentDemand: '現在の需要',
